<template>
  ...
  <div>
    ...
    <div v-if="flag">
      <div class="img">
        <img src="../../assets/order.gif" class="img100" />
      </div>
    ...
    <div v-else>
      ...
      <div v-else>
        <div v-if="shopList.length === 0">
          ...
          <div class="flex-ja">
            <div class="goto flex-ja" @click="goto">去购物</div>
          </div>
        </div>
        <!-- 已经登录并加购商品 -->
        <div v-if="shopList.length !== 0">
...
export default {
  ...
  methods: {
    ...
    shop() {
      //子组件分发的时间，用户勾选点击删除后，将list重新赋值更新成没删除的
